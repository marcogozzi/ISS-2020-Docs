	...
	public String toHtmlTable() {
		...
		for (ArrayList<Box> a : roomMap) {
			...
			for (Box b : a) {
				...
				if (b.isRobot()) {
					builder.append("<td>");
					builder.append("<table style=\"table-layouyt: fixed\">");
					
					builder.append("<tr>");
					builder.append("<td class=\"tl\"/>");	//top left
					builder.append("<td class=\"tr\"/>");	//top right
					builder.append("</tr>");
					
					builder.append("<tr>");
					builder.append("<td class=\"bl\"/>");	//top left
					builder.append("<td class=\"br\"/>");	//top right
					builder.append("</tr>");
					...
					builder.append("<td class=\"obstacle\"/>");
				else if (b.isDirty())
					builder.append("<td class=\"dirty\"/>");
				else
					builder.append("<td class=\"free\"/>");
			};
			builder.append("</tr>");
		}
		builder.append("</table>");
