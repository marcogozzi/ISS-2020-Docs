		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t012",targetState="prepareTea",cond=whenRequest("relayorder"))
				}	 
				state("prepareTea") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t013",targetState="prepareTea",cond=whenRequest("relayorder"))
				}	 
			}
		}
}
