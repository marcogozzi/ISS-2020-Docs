		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t014",targetState="checkTemp",cond=whenRequest("notify"))
				}	 
				state("checkTemp") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t115",targetState="checkTemp",cond=whenRequest("notify"))
					transition(edgeName="t116",targetState="replyClient",cond=whenReply("available"))
					transition(edgeName="t117",targetState="replyClient",cond=whenReply("full"))
				}	 
				state("replyClient") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t218",targetState="checkTemp",cond=whenRequest("notify"))
				}	 
			}
		}
}
