		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t08",targetState="checkTemp",cond=whenRequest("notify"))
				}	 
				state("checkTemp") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t19",targetState="checkTemp",cond=whenRequest("notify"))
					transition(edgeName="t110",targetState="replyClient",cond=whenReply("available"))
					transition(edgeName="t111",targetState="replyClient",cond=whenReply("full"))
				}	 
				state("replyClient") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t212",targetState="checkTemp",cond=whenRequest("notify"))
				}	 
			}
		}
}
