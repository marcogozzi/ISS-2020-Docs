...
public static final String topicForRoom = "/topic/roomstate";
public static final String topicForClient = "/topic/clientstate";
public static final String topicForMap = "/topic/mapstate";
public static final String topicForControl = "/topic/control";
