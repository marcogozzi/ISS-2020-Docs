		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t04",targetState="checkTemp",cond=whenRequest("notify"))
				}	 
				state("checkTemp") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t15",targetState="checkTemp",cond=whenRequest("notify"))
					transition(edgeName="t16",targetState="replyClient",cond=whenReply("available"))
					transition(edgeName="t17",targetState="replyClient",cond=whenReply("full"))
				}	 
				state("replyClient") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t28",targetState="checkTemp",cond=whenRequest("notify"))
				}	 
			}
		}
}
