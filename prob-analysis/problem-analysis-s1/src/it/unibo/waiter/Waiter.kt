		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
						...
						solve("consult('tearoomKB-PA-sprint1.pl')","") //set resVar	
					 ...
					 transition(edgeName="t09",targetState="checkTableAvail",cond=whenRequest("table"))
				}	 
				state("checkTableAvail") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t010",targetState="reach",cond=whenDispatch("clientatentrance"))
				}	 
				state("reach") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t011",targetState="reachp2",cond=whenReply("moveOk"))
					transition(edgeName="t012",targetState="reach",cond=whenReply("moveKo"))
				}	 
				state("reachp2") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t013",targetState="reachp3",cond=whenReply("moveOk"))
					transition(edgeName="t014",targetState="reachp2",cond=whenReply("moveKo"))
				}	 
				state("reachp3") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t015",targetState="takeOrder",cond=whenDispatch("placeorder"))
				}	 
				state("takeOrder") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t016",targetState="takeOrderp2",cond=whenReply("moveOk"))
					transition(edgeName="t017",targetState="takeOrder",cond=whenReply("moveKo"))
				}	 
				...
				state("serveOrder") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t019",targetState="serveOrderp2",cond=whenReply("moveOk"))
					transition(edgeName="t020",targetState="serveOrder",cond=whenReply("moveKo"))
				}	 
				state("serveOrderp2") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t021",targetState="serveOrderp3",cond=whenReply("moveOk"))
					transition(edgeName="t022",targetState="serveOrderp2",cond=whenReply("moveKo"))
				}	 
				state("serveOrderp3") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t023",targetState="getPayment",cond=whenDispatch("payment"))
				}	 
				state("getPayment") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t024",targetState="getPaymentp2",cond=whenReply("moveOk"))
					transition(edgeName="t025",targetState="getPayment",cond=whenReply("moveKo"))
				}	 
				state("getPaymentp2") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t026",targetState="escortToExit",cond=whenReply("moveOk"))
					transition(edgeName="t027",targetState="getPaymentp2",cond=whenReply("moveKo"))
				}	 
				...
				state("cleanTable") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t028",targetState="doClean",cond=whenReply("moveOk"))
					transition(edgeName="t029",targetState="cleanTable",cond=whenReply("moveKo"))
				}	 
				state("doClean") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t030",targetState="rest",cond=whenTimeout("local_tout_waiter_doClean"))   
					transition(edgeName="t031",targetState="checkTableAvail",cond=whenRequest("table"))
				}	 
				state("rest") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t032",targetState="atHome",cond=whenReply("moveOk"))
					transition(edgeName="t033",targetState="rest",cond=whenReply("moveKo"))
				}	 
