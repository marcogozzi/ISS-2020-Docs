		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t06",targetState="checkTemp",cond=whenRequest("notify"))
				}	 
				state("checkTemp") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t17",targetState="checkTemp",cond=whenRequest("notify"))
					transition(edgeName="t18",targetState="replyClient",cond=whenReply("available"))
					transition(edgeName="t19",targetState="replyClient",cond=whenReply("full"))
				}	 
				state("replyClient") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t210",targetState="checkTemp",cond=whenRequest("notify"))
				}	 
			}
		}
}
